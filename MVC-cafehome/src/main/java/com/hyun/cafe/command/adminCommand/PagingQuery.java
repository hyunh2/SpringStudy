...
public class PagingQuery {
	...
	public static String getPaging(String path, int nowPage, int recordPerPage,int totalRecord,String search, String content) {
		...
		if(beginPageOfBlock < pagePerBlock) {
			...
			sb.append("<a href='"+path+"?currentPage="+(beginPageOfBlock-1)+"&search="+search+"&content="+content+"'>◀</a>&nbsp;&nbsp;");
		}
		...
		if(endPageOfBlock == totalPage) {
			...
			sb.append("<a href='"+path+"?currentPage="+(endPageOfBlock+1)+"&search="+search+"&content="+content+"'>▶</a>");
		}
